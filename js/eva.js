 ...
 * continued at march 8th 2025 - v1.2.5
 *   - remove this.config or rename to CONFIG as constant
 */
;function eva(c){
  /* the version */
  ...
  this.request=async function(body,opt){
    ...
    let config={
      ...
      headers:{
        ...
        'X-Eva-Api-Version': CONFIG.apiVersion,
      },
    ...
    host=CONFIG.host;
    if(typeof CONFIG.authentication==='string'
      &&CONFIG.authentication.match(/^eva1\./)){
